...
FROM sys.dm_db_index_usage_stats ius
    INNER JOIN sys.indexes i ON i.index_id = ius.index_id AND ius.object_id = i.object_id
    INNER JOIN sys.dm_db_index_physical_stats(NULL,NULL,NULL,NULL,NULL) ips ON ius.object_id = ips.object_id
        AND ips.index_id = i.index_id
    INNER JOIN sys.objects o ON o.object_id = ius.object_id
    LEFT JOIN sys.dm_db_index_operational_stats (NULL,NULL,NULL,NULL ) ios ON i.object_id = ios.object_id
...
GROUP BY o.name, i.name, i.type_desc, ius.user_seeks,
